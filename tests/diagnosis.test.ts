...
describe("compatibility", () => {
  it("uses 干合 as best, the generating element as good and non-partner 正官 as caution", () => {
    expect(compatibility("甲")).toEqual({ best: ["己"], good: ["壬", "癸"], attracted: ["丙", "丁"], caution: ["辛"] });
    expect(compatibility("己")).toEqual({ best: ["甲"], good: ["丙", "丁"], attracted: ["庚", "辛"], caution: [] });
    expect(compatibility("丙")).toEqual({ best: ["辛"], good: ["甲", "乙"], attracted: ["戊", "己"], caution: ["癸"] });
    expect(compatibility("辛")).toEqual({ best: ["丙"], good: ["戊", "己"], attracted: ["壬", "癸"], caution: [] });
  });
