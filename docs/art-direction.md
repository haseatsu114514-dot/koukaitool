...
キャラクターの体色は、そのタイプのエレメント色に寄せます（木＝モスグリーン、火＝朱・コーラル、土＝山吹・黄土、金＝シルバー＋パール、水＝紺・ブルー）。茶系は線の色だけにし、体色には使いません。動物らしさが色で出しにくいタイプ（うさぎ・パンダ）は、四つ葉のクローバーや黄色の湯のみなど、小物でエレメント色を添えます。線の色 `#756653` は全キャラクター共通です。
