...
キャラクターの色は、そのタイプのエレメント色に寄せます（木＝緑、火＝朱・コーラル、土＝山吹・黄土、金＝シルバー＋パール、水＝紺・ブルー）。体色で出すと動物らしさが薄れるタイプ（グリズリー・うさぎ・パンダ）は、体は本来の色のまま、緑のリボン、四つ葉のクローバー、黄色の湯のみなど小物でエレメント色を添えます。妖狐は白地に朱の耳・隈取り・しっぽ。線の色 `#756653` は全キャラクター共通です。
