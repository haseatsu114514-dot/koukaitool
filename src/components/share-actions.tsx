...
async function exportCard(type: CharacterType) {
  ...
  ctx.fillStyle = "#faf8f3"; ctx.fillRect(0, 0, 1080, 1350);
  ctx.fillStyle = type.color; ctx.beginPath(); ctx.arc(540, 460, 320, 0, Math.PI * 2); ctx.fill();
  ctx.drawImage(image, 210, 130, 660, 660);
  ctx.textAlign = "center"; ctx.fillStyle = "#a45e4a"; ctx.font = '26px sans-serif'; ctx.fillText("STELLA FILE / MY PERSONALITY", 540, 94);
  ctx.fillStyle = "#403d35"; ctx.font = 'bold 52px sans-serif'; ctx.fillText(type.displayName, 540, 866, 940);
