...
export const GOD_COPY: Record<TenGod, { item: string; title: string; strength: string; hint: string }> = {
  ...
  傷官: { item: "トゲのあるバラ", title: "鋭いけど、実は傷つきやすい", strength: "頭の回転が速く、思ったことをズバッと言える人。その一言が鋭すぎて、毒舌と言われることも。でも本当は、人一倍傷つきやすくて繊細です。その感性の鋭さは、センスや表現力として大きな武器になります。", hint: "言いすぎたかなと思ったら、あとで一言フォローするだけで印象が変わります。" },
  偏財: { item: "マイク", title: "誰とでも仲良くなれる人気者", strength: "初対面でもすぐに打ち解けられる、コミュニケーションの達人。話題が豊富で、いるだけで場が盛り上がります。自然と人が集まってきて、顔の広さがチャンスを運んできます。", hint: "みんなに気をつかいすぎて疲れたら、ひとりの時間で充電を。" },
