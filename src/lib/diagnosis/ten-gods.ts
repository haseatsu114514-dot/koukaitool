...
export const GOD_COPY: Record<TenGod, { item: string; title: string; strength: string; hint: string }> = {
  比肩: { item: "ダンベル", title: "自分の力でどんどん強くなれる", strength: "誰かに頼るより、自分で鍛えて伸びていくタイプ。エネルギーが高く、ここぞという場面では底力を発揮できます。努力した分だけ、しっかり自分の力になっていく人です。", hint: "ひとりで頑張りすぎた日は、ちゃんと休むのもトレーニングのうち。" },
  ...
  食神: { item: "クッキー缶", title: "人生を楽しむのが上手", strength: "楽しいことを思いつくのが得意で、アイデアを出すのも、おしゃべりも上手な人。おいしいものや心地いいことを見つけるのもお手のものです。遊びや楽なほうに流れてしまう日もありますが、楽しむ力があるぶん、人生そのものが楽しくなっていきます。", hint: "気が乗らないことは、楽しめる工夫をひとつ足すと進みやすくなります。" },
  ...
  正官: { item: "腕時計", title: "まじめさが、信頼につながる", strength: "約束やルールを大切にする、まじめで誠実な人。任されたことに責任を持って向き合う姿勢が、少しずつ周りからの信頼につながっていきます。その積み重ねが、あなたの信用の証になっていきます。", hint: "きちんとしなきゃと思いすぎた日は、少し肩の力を抜いても大丈夫です。" },
