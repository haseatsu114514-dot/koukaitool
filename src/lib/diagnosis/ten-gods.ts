...
export const GOD_COPY: Record<TenGod, { item: string; title: string; strength: string; hint: string }> = {
  ...
  傷官: { item: "ハサミ", title: "鋭い感性を武器にできる", strength: "頭の回転が速く、思ったことをズバッと言える人。その一言が鋭すぎて、毒舌と言われることも。でも本当は、人一倍傷つきやすくて繊細です。その感性の鋭さは、センスや表現力として大きな武器になります。", hint: "言いすぎたかなと思ったら、あとで一言フォローするだけで印象が変わります。" },
  偏財: { item: "スマホ", title: "誰とでもすぐ仲良くなれる", strength: "初対面でもすぐに打ち解けられる、コミュニケーションの達人。話題が豊富で、いるだけで場が盛り上がります。自然と人が集まってきて、顔の広さがチャンスを運んできます。", hint: "みんなに気をつかいすぎて疲れたら、ひとりの時間でリセットを。" },
  正財: { item: "貯金箱", title: "コツコツ積み上げられる", strength: "お金も経験も、少しずつ着実に貯めていける人。派手さはなくても、コツコツ積み上げたものが、気づけば大きな安心になっています。その堅実さを見ている人は必ずいます。", hint: "たまには自分へのごほうびも。上手に使うことも、積み上げを続けるコツです。" },
  偏官: { item: "パンパンのスケジュール帳", title: "頼まれごとをテキパキこなせる", strength: "頼まれごとや予定がどんどん入ってきて、気づけばいつも忙しい人。でもそのぶん行動が早く、頼まれたことをテキパキ片づけられます。じっとしているより、動いているほうが調子がいいタイプです。", hint: "予定を詰め込みすぎたら、何もしない日をあえて作ってみて。" },
  正官: { item: "腕時計", title: "責任感で信頼を集められる", strength: "任されたことを最後までやり遂げる、責任感の強い人。ルールや約束を大切にするので、周りから「この人なら安心」と信頼されています。", hint: "うまくできない日があっても、あなたの信頼は簡単には崩れません。" },
