...
export const CHARACTER_TYPES: CharacterType[] = [
  ...
  { stem: "己", slug: "alpaca", displayName: "ほっとけないアルパカ", shortCatch: "困っている人を、ほっとけない。家族みたいなお世話係。", summary: "献身的で面倒見がよく、家族のようにみんなのお世話をしてしまうタイプ。和を大事にするバランサーで、人を育てるのが得意です。ただ、心配しすぎて大変な役まで引き受け、我慢をため込んでしまうことも。どこか独特な雰囲気を持つ、愛されキャラです。", strengths: ["家族のように人を思いやれる献身さ", "場の和を保つバランス感覚", "人をじっくり育てられる"], keywords: ["献身的", "バランサー", "育て上手"], motif: "畑", props: ["寄り添う子どものアルパカ"], backgroundMotifs: ["芽吹き"], imagePrompt: "A fluffy golden-cream alpaca standing front-facing with a big soft topknot, banana-shaped ears and a long fluffy neck, a small baby alpaca snuggled at its side, one sprout beside them, gentle worried-but-kind expression." },
  { stem: "庚", slug: "doberman", displayName: "正々堂々ドーベルマン", shortCatch: "遠回しな言い方は苦手。でも、誰より義理がたい。", summary: "白黒はっきりさせたい、筋の通ったタイプ。ズルや嘘が本当に苦手で、義理は何より大切にします。ストレートなぶん衝突も多く、好き嫌いがはっきり分かれやすい人。でも、好きになってくれる人からはとことん好かれます。", strengths: ["何より義理を守れる", "ズルや嘘をしないまっすぐさ", "問題から逃げずに向き合える"], keywords: ["義理がたい", "まっすぐ", "好き嫌いが分かれる"], motif: "鉄", props: ["小さな盾のバッジ"], backgroundMotifs: ["一本の旗"], imagePrompt: "A friendly silver-gray doberman with a white muzzle and natural soft floppy ears, upright but rounded posture, a small gold shield badge on a steel-blue collar, tiny white flag planted next to it, earnest expression, never aggressive." },
  ...
  { stem: "癸", slug: "capybara", displayName: "温泉カピバラ", shortCatch: "穏やかで、繊細。そばにいるだけで癒しがうつる人。", summary: "穏やかで繊細、そばにいるだけで周りに癒しが伝染していくタイプ。好きなことにはオタク気質でのめり込みます。優しそうに見えて、実はため込みがすごく、ある日突然疲れきってしまう一面も。人に寄り添いたいし、自分も寄り添ってほしい人です。", strengths: ["そばにいる人を自然と癒せる", "人の気持ちに寄り添える", "好きなことをとことん深められる"], keywords: ["癒し系", "オタク気質", "寄り添い"], motif: "雨露", props: ["頭の葉っぱ"], backgroundMotifs: ["湯気", "やさしい水面"], imagePrompt: "A relaxed warm-tan capybara soaking in a simple clear-blue oval hot spring, one small green leaf on its head, two soft steam curls, tiny peaceful eyes, broad rounded nose." },
];
